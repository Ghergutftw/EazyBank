    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (isMaintenanceMode != lastMaintenanceState || (isMaintenanceMode && !hasLoggedMaintenanceState)) {
            if (isMaintenanceMode) {
                System.out.println("🔧 CARDS SERVICE: Maintenance mode ENABLED");
            } else {
                System.out.println("✅ CARDS SERVICE: Maintenance mode DISABLED");
            }
        ...
        if (isMaintenanceMode) {
            ...
            String maintenanceMessage = String.format(
                """
                {
                  ...
                  "message": "EazyBank Cards Service is currently under maintenance",
